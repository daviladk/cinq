...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(a){if(a.ep)return;a.ep=!0;const o=n(a);fetch(a.href,o)}})();async function C(e,t={},n){return window.__TAURI_INTERNALS__.invoke(e,t,n)}const A="modulepreload",L=function(e){return"/"+e},W={},f=function(t,n,i){let a=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=r?.nonce||r?.getAttribute("nonce");a=Promise.allSettled(n.map(d=>{if(d=L(d),d in W)return;W[d]=!0;const p=d.endsWith(".css"),w=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${w}`))return;const l=document.createElement("link");if(l.rel=p?"stylesheet":A,p||(l.as="script"),l.crossOrigin="",l.href=d,s&&l.setAttribute("nonce",s),document.head.appendChild(l),p)return new Promise((u,m)=>{l.addEventListener("load",u),l.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return a.then(r=>{for(const s of r||[])s.status==="rejected"&&o(s.reason);return t().catch(o)})},I={network:"mainnet",pollingInterval:3e4};let v={initialized:!1,paymentCode:null,quaiAddress:null,balance:0n,utxoCount:0,zone:"Cyprus1"},q=[],N=[];async function S(e={}){const t={...I,...e};try{const{QiAgentWallet:n}=await f(async()=>{const{QiAgentWallet:l}=await import("./index-DoSyO7I7.js").then(u=>u.i);return{QiAgentWallet:l}},__vite__mapDeps([0,1])),{Mnemonic:i,HDNodeWallet:a}=await f(async()=>{const{Mnemonic:l,HDNodeWallet:u}=await import("./index-CSCCMl66.js");return{Mnemonic:l,HDNodeWallet:u}},__vite__mapDeps([2,1])),{wallet:o,mnemonic:r}=await n.create({network:t.network,pollingInterval:t.pollingInterval}),s=o.getPaymentCode(),d=i.fromPhrase(r),w=a.fromMnemonic(d,"m/44'/994'/0'/0/0").address;return v={initialized:!0,paymentCode:s,quaiAddress:w,balance:0n,utxoCount:0,zone:"Cyprus1"},window.__cinqWallet=o,window.__cinqMnemonic=r,o.onPaymentReceived(l=>{const u={amount:l.amount,senderPaymentCode:l.senderPaymentCode,txHash:l.txHash||"",timestamp:Date.now()};q.forEach(m=>m(u))}),o.onSenderDiscovered(l=>{N.forEach(u=>u(l))}),{mnemonic:r,paymentCode:s,quaiAddress:w}}catch(n){throw console.error("Failed to create wallet:",n),new Error(`Wallet creation failed: ${n}`)}}async function M(e,t={}){const n={...I,...t};try{const{QiAgentWallet:i}=await f(async()=>{const{QiAgentWallet:u}=await import("./index-DoSyO7I7.js").then(m=>m.i);return{QiAgentWallet:u}},__vite__mapDeps([0,1])),{Mnemonic:a,HDNodeWallet:o}=await f(async()=>{const{Mnemonic:u,HDNodeWallet:m}=await import("./index-CSCCMl66.js");return{Mnemonic:u,HDNodeWallet:m}},__vite__mapDeps([2,1])),r=await i.fromMnemonic(e,{network:n.network,pollingInterval:n.pollingInterval}),s=r.getPaymentCode(),d=a.fromPhrase(e),w=o.fromMnemonic(d,"m/44'/994'/0'/0/0").address;await r.sync();const l=await r.getBalance();return v={initialized:!0,paymentCode:s,quaiAddress:w,balance:l.balance,utxoCount:l.utxoCount,zone:"Cyprus1"},window.__cinqWallet=r,window.__cinqMnemonic=e,{paymentCode:s,quaiAddress:w}}catch(i){throw console.error("Failed to import wallet:",i),new Error(`Wallet import failed: ${i}`)}}async function _(){const e=window.__cinqWallet;if(!e)throw new Error("Wallet not initialized");const t=await e.getBalance();return v.balance=t.balance,v.utxoCount=t.utxoCount,t}async function x(e,t){const n=window.__cinqWallet;if(!n)throw new Error("Wallet not initialized");try{const i=await n.send(e,t);return await _(),{qiTxHash:i.qiTxHash,notifyTxHash:i.notifyTxHash,amount:t,recipient:e}}catch(i){throw console.error("Payment failed:",i),new Error(`Payment failed: ${i}`)}}function P(e){const t=window.__cinqWallet;if(!t)throw new Error("Wallet not initialized");t.startPolling(e)}function B(e){q.push(e)}function $(){return v.paymentCode}async function T(e,t,n={}){const i={...I,...n};try{const{QiAgentWallet:a}=await f(async()=>{const{QiAgentWallet:m}=await import("./index-DoSyO7I7.js").then(g=>g.i);return{QiAgentWallet:m}},__vite__mapDeps([0,1])),{Mnemonic:o,HDNodeWallet:r}=await f(async()=>{const{Mnemonic:m,HDNodeWallet:g}=await import("./index-CSCCMl66.js");return{Mnemonic:m,HDNodeWallet:g}},__vite__mapDeps([2,1])),s=JSON.parse(e),d=await a.deserialize(s,t,{network:i.network,pollingInterval:i.pollingInterval}),p=d.getPaymentCode(),w=o.fromPhrase(t),u=r.fromMnemonic(w,"m/44'/994'/0'/0/0").address;return v={initialized:!0,paymentCode:p,quaiAddress:u,balance:0n,utxoCount:0,zone:"Cyprus1"},window.__cinqWallet=d,window.__cinqMnemonic=t,await d.sync(),await _(),p}catch(a){throw console.error("Failed to deserialize wallet:",a),new Error(`Wallet restore failed: ${a}`)}}function h(e){const t=e.toString().padStart(19,"0"),n=t.slice(0,-18)||"0",i=t.slice(-18,-14);return`${n}.${i} Qi`}function z(e,t){const n=document.getElementById("app");n&&(!e.nodeRunning&&!e.walletInitialized?(n.innerHTML=k(),D(t)):e.walletInitialized?(n.innerHTML=R(e),H(e,t)):(n.innerHTML=Q(),O(t)))}function k(e){return`
    <div class="landing">
  ...
  `}function R(e,t){const n=e.peerId?`${e.peerId.slice(0,8)}...`:"Not connected",i=e.paymentCode?`${e.paymentCode.slice(0,12)}...`:"N/A",a=e.quaiAddress?`${e.quaiAddress.slice(0,10)}...${e.quaiAddress.slice(-6)}`:"N/A";return`
    <div class="main-app">
      <header class="header">
        ...
        <div class="card wallet-card">
          ...
          <div class="wallet-addresses">
            <div class="address-row">
              ...
              <code id="payment-code" title="${e.paymentCode||""}">${i}</code>
