...
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const c of i)if(c.type==="childList")for(const s of c.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function a(i){const c={};return i.integrity&&(c.integrity=i.integrity),i.referrerPolicy&&(c.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?c.credentials="include":i.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function n(i){if(i.ep)return;i.ep=!0;const c=a(i);fetch(i.href,c)}})();async function g(e,t={},a){return window.__TAURI_INTERNALS__.invoke(e,t,a)}const O="modulepreload",z=function(e){return"/"+e},N={},y=function(t,a,n){let i=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),l=s?.nonce||s?.getAttribute("nonce");i=Promise.allSettled(a.map(r=>{if(r=z(r),r in N)return;N[r]=!0;const d=r.endsWith(".css"),v=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${r}"]${v}`))return;const u=document.createElement("link");if(u.rel=d?"stylesheet":O,d||(u.as="script"),u.crossOrigin="",u.href=r,l&&u.setAttribute("nonce",l),document.head.appendChild(u),d)return new Promise((m,w)=>{u.addEventListener("load",m),u.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${r}`)))})}))}function c(s){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=s,window.dispatchEvent(l),!l.defaultPrevented)throw s}return i.then(s=>{for(const l of s||[])l.status==="rejected"&&c(l.reason);return t().catch(c)})},$={network:"orchard",pollingInterval:3e4};let f={initialized:!1,paymentCode:null,quaiAddress:null,balance:0n,utxoCount:0,zone:"Cyprus1"},A=[],F=[];async function x(e={}){const t={...$,...e};try{const{QiAgentWallet:a}=await y(async()=>{const{QiAgentWallet:u}=await import("./index-DoSyO7I7.js").then(m=>m.i);return{QiAgentWallet:u}},__vite__mapDeps([0,1])),{Mnemonic:n,HDNodeWallet:i}=await y(async()=>{const{Mnemonic:u,HDNodeWallet:m}=await import("./index-CSCCMl66.js");return{Mnemonic:u,HDNodeWallet:m}},__vite__mapDeps([2,1])),{wallet:c,mnemonic:s}=await a.create({network:t.network,pollingInterval:t.pollingInterval}),l=c.getPaymentCode(),r=n.fromPhrase(s),v=i.fromMnemonic(r,"m/44'/994'/0'/0/0").address;return f={initialized:!0,paymentCode:l,quaiAddress:v,balance:0n,utxoCount:0,zone:"Cyprus1"},window.__cinqWallet=c,window.__cinqMnemonic=s,c.onPaymentReceived(u=>{const m={amount:u.amount,senderPaymentCode:u.senderPaymentCode,txHash:u.txHash||"",timestamp:Date.now()};A.forEach(w=>w(m))}),c.onSenderDiscovered(u=>{F.forEach(m=>m(u))}),{mnemonic:s,paymentCode:l,quaiAddress:v}}catch(a){throw console.error("Failed to create wallet:",a),new Error(`Wallet creation failed: ${a}`)}}async function M(e,t={}){const a={...$,...t};try{const{QiAgentWallet:n}=await y(async()=>{const{QiAgentWallet:m}=await import("./index-DoSyO7I7.js").then(w=>w.i);return{QiAgentWallet:m}},__vite__mapDeps([0,1])),{Mnemonic:i,HDNodeWallet:c}=await y(async()=>{const{Mnemonic:m,HDNodeWallet:w}=await import("./index-CSCCMl66.js");return{Mnemonic:m,HDNodeWallet:w}},__vite__mapDeps([2,1])),s=await n.fromMnemonic(e,{network:a.network,pollingInterval:a.pollingInterval}),l=s.getPaymentCode(),r=i.fromPhrase(e),v=c.fromMnemonic(r,"m/44'/994'/0'/0/0").address;await s.sync();const u=await s.getBalance();return f={initialized:!0,paymentCode:l,quaiAddress:v,balance:u.balance,utxoCount:u.utxoCount,zone:"Cyprus1"},window.__cinqWallet=s,window.__cinqMnemonic=e,{paymentCode:l,quaiAddress:v}}catch(n){throw console.error("Failed to import wallet:",n),new Error(`Wallet import failed: ${n}`)}}async function S(){const e=window.__cinqWallet;if(!e)throw new Error("Wallet not initialized");const t=await e.getBalance();return f.balance=t.balance,f.utxoCount=t.utxoCount,t}async function Q(){try{const{JsonRpcProvider:e}=await y(async()=>{const{JsonRpcProvider:s}=await import("./index-CSCCMl66.js");return{JsonRpcProvider:s}},__vite__mapDeps([2,1])),t=f.quaiAddress;if(!t)return 0n;const n=(localStorage.getItem("cinq_network")||"orchard")==="mainnet"?"https://rpc.quai.network":"https://rpc.orchard.quai.network";return await new e(n).getBalance(t)}catch(e){return console.error("Failed to get Quai balance:",e),0n}}async function U(e,t){const a=window.__cinqWallet;if(!a)throw new Error("Wallet not initialized");try{const n=await a.send(e,t);return await S(),{qiTxHash:n.qiTxHash,notifyTxHash:n.notifyTxHash,amount:t,recipient:e}}catch(n){throw console.error("Payment failed:",n),new Error(`Payment failed: ${n}`)}}function E(e){const t=window.__cinqWallet;if(!t)throw new Error("Wallet not initialized");t.startPolling(e)}function H(){const e=window.__cinqWallet;e&&e.stopPolling()}function V(e){A.push(e)}function j(){return f.paymentCode}function Y(){return f.quaiAddress}async function q(){const e=window.__cinqWallet;if(!e)throw new Error("Wallet not initialized");const t=e.serialize();return JSON.stringify(t)}async function G(e,t,a={}){const n={...$,...a};try{const{QiAgentWallet:i}=await y(async()=>{const{QiAgentWallet:w}=await import("./index-DoSyO7I7.js").then(C=>C.i);return{QiAgentWallet:w}},__vite__mapDeps([0,1])),{Mnemonic:c,HDNodeWallet:s}=await y(async()=>{const{Mnemonic:w,HDNodeWallet:C}=await import("./index-CSCCMl66.js");return{Mnemonic:w,HDNodeWallet:C}},__vite__mapDeps([2,1])),l=JSON.parse(e),r=await i.deserialize(l,t,{network:n.network,pollingInterval:n.pollingInterval}),d=r.getPaymentCode(),v=c.fromPhrase(t),m=s.fromMnemonic(v,"m/44'/994'/0'/0/0").address;return f={initialized:!0,paymentCode:d,quaiAddress:m,balance:0n,utxoCount:0,zone:"Cyprus1"},window.__cinqWallet=r,window.__cinqMnemonic=t,await r.sync(),await S(),d}catch(i){throw console.error("Failed to deserialize wallet:",i),new Error(`Wallet restore failed: ${i}`)}}function I(e){const t=e.toString().padStart(19,"0"),a=t.slice(0,-18)||"0",n=t.slice(-18,-14);return`${a}.${n} Qi`}function J(e){return e===0n?"0.00 QUAI":(Number(e)/1e18).toFixed(4)+" QUAI"}function K(e,t){const a=document.getElementById("app");a&&(e.walletInitialized&&e.nodeRunning?(a.innerHTML=X(e),ue(e,t)):(e.walletInitialized&&e.nodeRunning,a.innerHTML=L(e),W(e,t)))}function L(e,t){const a=e.hasSavedWallet;return a&&e.walletInitialized?`
      <div class="landing">
