...
use crate::grid::userid::{QuaiZone, UserId};
...
impl SbtProof {
    ...
    pub fn verify(&self) -> Result<bool, SbtError> {
        ...
        Err(SbtError::NotImplemented(
            "Signature verification not yet implemented".into(),
        ))
    }
}
...
impl SbtManager {
    ...
    pub fn is_available(&self, zone: QuaiZone) -> bool {
        self.contracts.for_zone(zone).is_some() && self.rpc_endpoints.contains_key(&zone.code())
    }
    ...
    pub async fn get_user_id(
        ...
        Err(SbtError::NotImplemented(
            "Contract calls not yet implemented".into(),
        ))
    }
    ...
    pub async fn verify_ownership(
        ...
        let zone_code = user_id.zone.ok_or(SbtError::InvalidSignature(
            "Legacy IDs cannot be verified on-chain".into(),
        ))?;
    ...
    pub fn create_proof_message(&self, user_id: &UserId, peer_id: &str) -> String {
...
mod tests {
    ...
    fn test_proof_message_format() {
        ...
        assert_eq!(
            message,
            "cinq-identity:25551234567:12D3KooWTest123:1700000000"
        );
    }
